...
* Added a variable for id as an integer ([7242975](https://github.com/anqqaw/foodtoday/commit/7242975fc5442c1fac8052a96044bd60954f1090))
* Added a variable for id as an integer ([1d60eff](https://github.com/anqqaw/foodtoday/commit/1d60eff597197330d2a590ebc8905d73c4ca764e))
* Added afterAll and afterEach ([b5e213d](https://github.com/anqqaw/foodtoday/commit/b5e213da2ab924fcd96620e50ae797187f3c2510))
* Added afterEach ([dbb959a](https://github.com/anqqaw/foodtoday/commit/dbb959a50ec06f4986180a11108dfc43bf783bed))
* Added afterEach and afterAll for getRandom's test ([bf669d7](https://github.com/anqqaw/foodtoday/commit/bf669d775802131f9be401ad05c9853f8243038b))
* Added afterEach for get-list test ([e499fa6](https://github.com/anqqaw/foodtoday/commit/e499fa61b45a64be7c2a1710622b655271dafec1))
* Added auth.ts file to authenticate not using google ([d07f5cc](https://github.com/anqqaw/foodtoday/commit/d07f5cc7c961c1e4d2b3c88bfbcd82b004c4b0fb))
* Added bcrypt for logging in ([e1c6590](https://github.com/anqqaw/foodtoday/commit/e1c65905e50ffeef35aae7dffdc111c352d67153))
* Added beforeEach and google verification for getRandom's test ([694cd7c](https://github.com/anqqaw/foodtoday/commit/694cd7cb1b0fd6b0d338e96e8cb698fe731819de))
* Added beforeEach for get-list test ([85e1c11](https://github.com/anqqaw/foodtoday/commit/85e1c11e4849c69e6bae8101f328f7175166a454))
* Added beforeEach method for clearshoppinglist methods test ([751d6ec](https://github.com/anqqaw/foodtoday/commit/751d6ec1eb91eb84e64b64133c2b5dcdc9a39bd8))
* Added beforeEach method for deleting from shopping list's test ([c403b8d](https://github.com/anqqaw/foodtoday/commit/c403b8db2f000caeef8c54637d84aa02fb36a5c7))
* Added black theme to dinner list and updated the view ([c0d955b](https://github.com/anqqaw/foodtoday/commit/c0d955bc9f262bd825f680d285ff2fc97e7e4fb1))
* Added black theme to shopping list ([1f0bc8e](https://github.com/anqqaw/foodtoday/commit/1f0bc8e8ba9f7d5570f7370f32341a51628f1303))
* Added darker theme for dinner list ([d6cb594](https://github.com/anqqaw/foodtoday/commit/d6cb5949fa81cc5571570cc296aa0237946418d1))
* Added endpoint for users addToShoppingList ([2607401](https://github.com/anqqaw/foodtoday/commit/260740107260ef815fecb52f627c92124651896d))
* Added expect's to deleting from shoppinglist tests ([80512f0](https://github.com/anqqaw/foodtoday/commit/80512f08bca891c0df3cc8b559e12f54a37724ae))
* Added google token verification to backend ([3563526](https://github.com/anqqaw/foodtoday/commit/3563526b8818d75567f6e0c9bc67c3d0a52426cb))
* Added google verification to beforeEach and added afterEach method to test ([c304844](https://github.com/anqqaw/foodtoday/commit/c304844bd4270f9cb885fb916a9add6e60f173f5))
* Added handleAddItem method to shoppinglist.tsx ([2eb7de9](https://github.com/anqqaw/foodtoday/commit/2eb7de98a407a14504c6e480b69ac960ea3a8fc1))
* Added logos ([72758c8](https://github.com/anqqaw/foodtoday/commit/72758c8991dd25344383aa5d2978611271e0f17f))
* Added message for status code 500 for get-list's test ([c9bf518](https://github.com/anqqaw/foodtoday/commit/c9bf5186e050bcacddf88de646c4248e1f3f0d20))
* Added messages for status code 200 in the test ([c0ba66b](https://github.com/anqqaw/foodtoday/commit/c0ba66b4fcbf9b6f89d0cd39fc3805443aaa2be6))
* Added method to add a new item to shopping list ([fdb4984](https://github.com/anqqaw/foodtoday/commit/fdb4984fcd7cb9c001e84e8f275365c6c24971c1))
* Added method to add to shopping list in shopping list as user swipes up ([f849b88](https://github.com/anqqaw/foodtoday/commit/f849b8839b26d509b1f174bcfddac11c4703b3dc))
* Added method to api.tsx ([b656c01](https://github.com/anqqaw/foodtoday/commit/b656c011dee4cddfb322b284322d2d59f87b7411))
* Added other tests for getRandom ([55d5f1e](https://github.com/anqqaw/foodtoday/commit/55d5f1edab29cf96208d7eb3065b8ddff633809a))
* Added password to schema prisma ([80ca0e9](https://github.com/anqqaw/foodtoday/commit/80ca0e9d48adcfbe0e106ee2c14655e8b0a0f8f7))
* Added resetRedisMock() to shoppinglist tests ([e65ba5f](https://github.com/anqqaw/foodtoday/commit/e65ba5fa4a8df6d6a994d76ae816df1138340aac))
* Added setupEnv file ([5c8e4ce](https://github.com/anqqaw/foodtoday/commit/5c8e4ce205c552a9abe11daccd97d2971e6731fe))
* Added setupFiles to jest.config.js ([0879a8a](https://github.com/anqqaw/foodtoday/commit/0879a8a4a5970aeb4f36003b5bc59e3dba1fb56c))
* Added style to dinnerdetails ([24f156a](https://github.com/anqqaw/foodtoday/commit/24f156a3bbe67371b50e0b726c2d3657ae7fe570))
* Added swiping method to shoppinglistitemcard ([0820af6](https://github.com/anqqaw/foodtoday/commit/0820af67dfe7c0503f8fbe9866bdba51849f4dcc))
* Added test database for backend and updated the command for npm test ([ac8bccc](https://github.com/anqqaw/foodtoday/commit/ac8bcccf0a229a09ea5383917438085ac12dd8b5))
* Added test for /dinners/addtoshoppinglist ([5469e73](https://github.com/anqqaw/foodtoday/commit/5469e73a2391b411288fb16dbf22d40f2377dc51))
* Added test for dinners getById method ([6e819ef](https://github.com/anqqaw/foodtoday/commit/6e819ef641f0b2b52d756ff345e59a36c707e5b4))
* Added test for getById's error 404 ([945abfb](https://github.com/anqqaw/foodtoday/commit/945abfbbe5699fe240fec3b210b41050c4f259e4))
* Added test for status 200 for clearing shopping list ([2f7ac14](https://github.com/anqqaw/foodtoday/commit/2f7ac14d9e8769e06bc440a9f97a4362831163b7))
* Added test for status 500 for clearshoppinglist ([72dfd8f](https://github.com/anqqaw/foodtoday/commit/72dfd8f2249ae799586e53018594b0b74582bf51))
* Added test for toggling shoppinglist's item ([f158fe1](https://github.com/anqqaw/foodtoday/commit/f158fe1f0369d21e7423f3983afe8e1fc786291a))
* Added text font, made black overlay darker and moved dinner.title closer to overlays top ([7a3da76](https://github.com/anqqaw/foodtoday/commit/7a3da76314b220902887d77c7efcee047968ee14))
* Added the yellow color to text ([d6b38df](https://github.com/anqqaw/foodtoday/commit/d6b38df2a9f0b05644d12e6da9ef8c07ebcfe760))
* Changed google.ts to verifyToken.ts to be able to log in without google ([b1ccb87](https://github.com/anqqaw/foodtoday/commit/b1ccb875dd72277397bbfa5b46c4fb8ab5217307))
* Installed cross-env to backend and ran npm audit to fix vulneratbilities ([d80444b](https://github.com/anqqaw/foodtoday/commit/d80444b5e7a82f05f7480614e1a7ac7e1781ba6b))
* Installed dotenv and cross-env ([2a169a1](https://github.com/anqqaw/foodtoday/commit/2a169a12e35aa195f99b63c664b8b471e8fe9a0a))
* Installed dotenv for backend ([b011897](https://github.com/anqqaw/foodtoday/commit/b01189755d56332375df348b9215740a22f1e6e9))
* Installed lucide-react ([aa40084](https://github.com/anqqaw/foodtoday/commit/aa400848267d9897c10273c856b69bff650d6dc5))
* Made login view black ([3f5ee04](https://github.com/anqqaw/foodtoday/commit/3f5ee04146d602cd0c22990e310c29d75680daf4))
* Updated DinnerDetails add to shopping list button ([e3e2c99](https://github.com/anqqaw/foodtoday/commit/e3e2c99b6d01106434fb338d296a14ad861d8774))
* Updated DinnerDetails look ([22eb643](https://github.com/anqqaw/foodtoday/commit/22eb64334b20d89972a34b654fd103dbc77a626f))
* Updated loginview frontend ([47feead](https://github.com/anqqaw/foodtoday/commit/47feead598a75f4d3bfb275078a0c6ba56219152))


### Bug Fixes

* Add runinband to jest tests ([2b27069](https://github.com/anqqaw/foodtoday/commit/2b270697dce302d97a66edd457f49593107abfef))
* Added =&gt; which was left behind ([f742fca](https://github.com/anqqaw/foodtoday/commit/f742fca988d7b18afb7ea35961ff2f62d215f54b))
* Added explicit before calling endpoint and switched jest to use findUnique isntead of dfindMany ([6e20b17](https://github.com/anqqaw/foodtoday/commit/6e20b171b8f7276807cc1f1f58a558b65a1fa371))
* Fixed 2 test with changing dinners.ts method addToShoppingList ([92db1e6](https://github.com/anqqaw/foodtoday/commit/92db1e6885d956517947a17041a88d49b0a30587))
* Fixed app.ts added to new method missing / ([f24f033](https://github.com/anqqaw/foodtoday/commit/f24f033f81093e85d400e6080e51bae247f6942c))
* Fixed app.ts to work with new file ([fbbd8df](https://github.com/anqqaw/foodtoday/commit/fbbd8df4c3d7b143b378035e63cbf29a2b57e288))
* Fixed createShoppingListItem method in backend ([c6dd428](https://github.com/anqqaw/foodtoday/commit/c6dd428b3d7561f7420dbed3fd4d13b10f15039b))
* Fixed createShoppingListItem to use .get not .post ([6680dce](https://github.com/anqqaw/foodtoday/commit/6680dce04aabb34936b4412ab84310bf0911d460))
* Fixed dinners test ([00e26ef](https://github.com/anqqaw/foodtoday/commit/00e26ef6650ea141ea64d94b204f3e583202fe7f))
* Fixed expect.toBe and removed comments ([590a0c1](https://github.com/anqqaw/foodtoday/commit/590a0c104450e22b9b61683c7c17c31526e06ab0))
* Fixed expecting 500 and returning 200 ([095c52a](https://github.com/anqqaw/foodtoday/commit/095c52a2945f964f7e83d0afe88917754d5c1291))
* Fixed failing test and renamed test ([f52e011](https://github.com/anqqaw/foodtoday/commit/f52e01154a4289061a0480f98ea2ab0f7465431e))
* Fixed jest.config.ts setup files to match setupEnv.ts ([1f18df2](https://github.com/anqqaw/foodtoday/commit/1f18df2e15482780811e770265dfc24b69f9f572))
* Fixed jest.mock going to correct fire ([fae140c](https://github.com/anqqaw/foodtoday/commit/fae140c48605d2d4b3d8d4dbd9473c14f3bde3c6))
* Fixed no-shadowed-variable ([b71bbf8](https://github.com/anqqaw/foodtoday/commit/b71bbf816f4b5e3ed6ffb6d5e1adc58c1eceea46))
* Fixed playwright test ([94ec79d](https://github.com/anqqaw/foodtoday/commit/94ec79d5932d1933b8402e16e714b0d7fd55cac5))
* Fixed prisma import ([bdc8565](https://github.com/anqqaw/foodtoday/commit/bdc8565e5b8ae3906b87cb5ab234a56005246c33))
* Fixed problem of adding to shoppinglist ([7e7647a](https://github.com/anqqaw/foodtoday/commit/7e7647a26de060cdd0ab1497932919849779cc9b))
* Fixed problem: added searchDinner methods to getRandom methods test ([e55c15b](https://github.com/anqqaw/foodtoday/commit/e55c15bc741cd63c6f248e6012c8a4ce976bfe1d))
* Fixed returning 405 and expecting 400 ([cf8ddc3](https://github.com/anqqaw/foodtoday/commit/cf8ddc3b130fcc12188f5f4f4add5c2de10dd26e))
* Fixed shoppingList to add shoppinglist not title ([39ee7f0](https://github.com/anqqaw/foodtoday/commit/39ee7f0507ac8a26337d3ef84ff1f10ce8b64583))
* Fixed test ([487fa3e](https://github.com/anqqaw/foodtoday/commit/487fa3ef00837618b7bece39664b1842892be21e))
* Fixed test by removing one expect ([83c596f](https://github.com/anqqaw/foodtoday/commit/83c596f19fef210f25ea8ee0d1aa850ee1d81bf6))
* Fixed tests to match new function ([2c2c3f8](https://github.com/anqqaw/foodtoday/commit/2c2c3f871d6138d649a2d64f1514b1ee222d71c7))
* Fixed to swipe down to add ([4c1ed64](https://github.com/anqqaw/foodtoday/commit/4c1ed644f6627f4ceec7cbbe561bf908bfd9a5a6))
* Recreate test database on starting each test run ([ae9099c](https://github.com/anqqaw/foodtoday/commit/ae9099c59eef377a3ca90cff3d13d24a3f8eceff))
* Removed async's from describes ([e51295b](https://github.com/anqqaw/foodtoday/commit/e51295bafd2691c0c5fb856e7dde814e86502e11))
* Removed dotEnv from config.ts ([384c986](https://github.com/anqqaw/foodtoday/commit/384c9865fd69198af6dfb67962fd8b228a966012))
* Removed trailing slash ([b32905a](https://github.com/anqqaw/foodtoday/commit/b32905a8b354c06a34478eb0b1130b2109107a71))
* Renamed shoppingList.ts ([1d49647](https://github.com/anqqaw/foodtoday/commit/1d49647ed6d41eb85c8fa412a267c91af3f24a9c))
* Run actions tests against test database ([eb1a54c](https://github.com/anqqaw/foodtoday/commit/eb1a54c6ac82195158fc3c4c959d5ef4e0bdb0f6))
* Seeded a dinner before running the test ([d0d695d](https://github.com/anqqaw/foodtoday/commit/d0d695dbbb31dddd9f67bf1adafa8c89717de519))
* Setup test database for each run ([bbf4322](https://github.com/anqqaw/foodtoday/commit/bbf43220fb7be70e176b5d81502721c77b1d3ca3))
* Switched to joint prisma with controllers ([2357018](https://github.com/anqqaw/foodtoday/commit/2357018166d77e23afc0b349aa3c8747b19b550b))
* Switched to joint prisma with tests ([f30cc24](https://github.com/anqqaw/foodtoday/commit/f30cc24d491b51139deeb346f247713826d5d16a))
* Switched users.ts name to shoppingList.ts ([1ce5da2](https://github.com/anqqaw/foodtoday/commit/1ce5da24bef59662e41b40ca7446c3568a5a3416))
* Update failing test due to parallelization ([9bd0d5d](https://github.com/anqqaw/foodtoday/commit/9bd0d5d240ae62a4a8f8c4195957875d0d286ed2))
* Updated shoppinglist to be updated descending to get new items to top ([8901984](https://github.com/anqqaw/foodtoday/commit/890198435a2eccaac0c20275b9d7b44b117d8e6e))
* Updated timers while user swipes in shoppinglist ([abdb40b](https://github.com/anqqaw/foodtoday/commit/abdb40b42eb795bd4a74f648ae68c0c2631371e9))
