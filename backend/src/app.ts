...
export function createApp() {
  ...
  privateRouter.get('/dinners/convertShoppingList', dinners.convertShoppingList);
  ...
  privateRouter.delete('/users/deletefromshoppinglist', users.deleteFromShoppingList);
